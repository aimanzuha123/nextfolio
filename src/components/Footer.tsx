      ...
      <div className="container-main py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-5 max-w-[220px]">
              AI-powered portfolio generator for students & freshers.
            </p>
            <div className="antigravity-badge text-[0.65rem]">
        ...
        <div className="mt-14 pt-6 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600">
            © {new Date().getFullYear()} Nextfolio. All rights reserved.
          </p>
          <div className="flex items-center gap-5">
            ...
            {[
              ...
              <a key={i} href="#" className="text-slate-600 hover:text-slate-400 transition-colors">
                {icon}
              </a>
            ))}
          </div>
